...
ule=unique(le);
fprintf('3)Total of different words with maximum input n: %0.1f\n',length(ule));
...
fprintf('3)The probability of the random word generator to generate a valid Portuguese word is %0.03f\n',prob);
